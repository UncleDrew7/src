                    ...
                    <c:if test="${object eq 'courses'}">
                        ...
                        <div class="table-responsive">
                            <div class="col-sm-2">
                                ...
                                <label><input type="checkbox" id="getClosed" name="getClosed" onclick="includeClosedCourses()" value="getClosed"  style="height: 18px;width: 18px;"> <spring:message code="manageCourse.closedCourses" /></label>
...
//    major manipulations
    ...
    function includeClosedCourses() {
         // alert("kdkdk");
        window.location.href='${url}/admin/manage-courses2/courses';
    }
