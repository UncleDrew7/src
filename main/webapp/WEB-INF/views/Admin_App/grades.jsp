    ...
    <div class="content">
        ...
        <div role="tabpanel" class="tab-pane active" id="home">
            <div class="row mainContainer">
                ...
                <label><input type="checkbox" id="retake" name="retakeCheck" onclick="getRetakeList()" value="retakeCheck"  style="height: 18px;width: 18px;"> <spring:message code="manageGrades2.retakeGrade" /></label>

                <div class="form-group pull-right">
                    <div class="btn-group" role="group" aria-label="...">
                        <a type="button" class="btn btn-default"  onclick="exportHighestGradeRecord()"><spring:message code="manageGrades2.exportHighestGradeRecord" /> <span class="glyphicon glyphicon-download" aria-hidden="true"></span></a>
                ...
                <div class="form-group pull-right">
                    <div class="btn-group" role="group" aria-label="...">
                        ...
                        <%--<a type="button" class="btn btn-default"  href="${url}/admin/download/student-grades-excel/${semesterId}/${majorId}/${intakeId}"><spring:message code="manageGrades2.exportGradeRecord" /> <span class="glyphicon glyphicon-download" aria-hidden="true"></span></a>--%>
                    </div>
                </div>
                ...
                <div class="col-sm-10 ">
                    ...
                    <div class="row firstContainer">
                        ...
                        <div class="col-sm-8 ">
                            <div class="majorFilter pull-left">
                                <%--<a href="${url}/admin/major/null" class="majorLable">Major:</a>&nbsp;--%>
                                <a class="majorLable"><spring:message code="manageUsers2.major" /></a>&nbsp;
                                <select  autocomplete="off" id="majorSelect" class="selectMajor" style="width:240px;">
                                    ...
                                    <b><spring:message code="manageUsers2.intake" /></b>&nbsp;
                    ...
                    <div style="min-height: 400px" class=" bigCardContainer">
                        ...
                        <table  id="customers">
                            ...
                            <tr>
                                ...
                                <th ><spring:message code="enrollmentList.studentId"/></th>
                                <th ><spring:message code="enrollmentList.studentName"/></th>
                                <%--<th ><spring:message code="enrollmentList.creditsEarned"/></th>--%>
                                <c:forEach var="courses" items="${semesterCourseList}">
                                    <th ><a href="${url}/admin/view/course/${courses.childCourseId}"><c:out value="${courses.courseName}"/><br>${courses.courseShortName}</a></th>
                                </c:forEach>
                            ...
                            <tbody>
                            <c:forEach var="studentList" items="${studentList}" varStatus="index">
                            <tr>
                                <td>${index.count}</td>
                                <td><c:out value="${studentList.userId}"/></td>
                                ...
                                <c:forEach var="courses" items="${semesterCourseList}">
                                    <td>
                                        <c:forEach var="grades" items="${courseGradesList}">
                                            <c:if test="${courses.childCourseId eq grades.courseId and studentList.userId eq grades.studentId }">
                                                <c:out value="${grades.finalAll}"/>
                                            </c:if>
                                        </c:forEach>
                                    </td>
                                </c:forEach>
...
<script>
    ...
    function filterSemester(semesterId) {
        ...
        window.location.href = '${url}/admin/grades?major=${majorId}&intake=${intakeId}&semester=' + semesterId;
...
//        else {
            ...
            window.location.href = '${url}/admin/grades?major='+thisvalue + '&intake=${intakeId}&semester=${semesterId}';
//        }
...
//        }
    ...
    $("#intakeSelect").change(function(){
        ...
        window.location.href = '${url}/admin/grades?major=${majorId}&intake=' + thisvalue + '&semester=${semesterId}';
    ...
    function exportHighestGradeRecord() {
        ...
        if ( ${!empty majorId} && ${!empty intakeId} && ${!empty semesterId}){
           ...
           alert("major or intake or semester is null!");
            <%--alert(<spring:message code="manageGrades2.errormsg" />);--%>
        }

    }

    function exportGradeRecord() {
...
//        alert("get retake");
        window.location.href='${url}/admin/grades2';
    }
