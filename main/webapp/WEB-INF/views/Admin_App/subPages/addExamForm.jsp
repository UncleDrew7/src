            ...
            <div class="card bigCardContainer">
                ...
                <form id="examForm" class="form-horizontal" >
                    ...
                    <div class="formBox">
                            ...
                            <div class="col-sm-9">
                                <select autocomplete="off" onfocus='this.size=10;' onblur='this.size=1;' onchange='this.size=1; this.blur();' class="form-control" id="majorSelect" name="majorId" required>
                                    ...
                                    <c:forEach var = "major" items="${majorSelectList}">
                                        <option value="${major.majorId}" selected> <c:out value="${major.majorName}"/></option>
                                    </c:forEach>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label class="control-label col-sm-3" for="courseSelect"><spring:message code="main.course" /></label>
                            <div class="col-sm-9">
                                <select autocomplete="off" onfocus='this.size=10;' onblur='this.size=1;' onchange='this.size=1; this.blur();' class="form-control" id="courseSelect" name="parentCourseId" required>
                                    ...
                                    <c:forEach var = "courselistSelect" items="${examFormSelectCourseList}">
                                        <option value="${courselistSelect.parentCourseId}" selected> (${courselistSelect.courseName})<c:out value="${courselistSelect.courseShortName}"/></option>
                                    </c:forEach>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label class="control-label col-sm-3" for="courseSelect"><spring:message code="addExamForm.teacher" /></label>
                            <div class="col-sm-9">
                                <select autocomplete="off" onfocus='this.size=10;' onblur='this.size=1;' onchange='this.size=1; this.blur();' class="form-control" id="teacherSelect" name="teacherId" required>
                                    <option value=""><spring:message code="addExamForm.selectTeacher" /></option>
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text"  autocomplete="off" class="form-control" id="weight" placeholder='<spring:message code="addExamForm.weight" />' name="weight" >
                                </div>
                            </div>
