...
<div class="content">
    ...
    <ul class="breadcrumbs">
        ...
        <li class="last active"><a ><spring:message code="examOverviewReport.examOverview"/></a></li>
    </ul>
</div>
    ...
    <div class=" card mainCardContainer">
                    ...
                    <div class="table-responsive csgoContaier">
                        <table  cellspacing="0" width="100%" id="gradeTable" class="table table-bordered table-hover">
                            ...
                            <tr>
                                ...
                                <th ><spring:message code="enrollmentList.ExamGrade"/>/${examDetail.weight}</th>
                                <th ><spring:message code="enrollmentList.ExamResult"/></th>
                            </tr>
                            </thead>
                                ...
                                <tr>
                                    ...
                                    <c:forEach var="gradeitems" items="${examGrades}">
                                                <c:if test="${gradeitems.studentId eq studentList.userId }">
                                                    <td>  <c:out value="${gradeitems.examScore}"/></td>
                                                    <td>  <c:out value="${gradeitems.examResult}"/></td>
        ...
        <div class="finalGradeBox">
            <div class="form-group pull-right">
                <div class="btn-group" role="group" aria-label="...">
                    <a  href="${url}/admin/exam/grade/updateExamGradesToCourse/${examId}" type="button" class="btn btn-default"><spring:message code="courseStudentGrdeOverview.subCourseGrades"/> <span class="glyphicon glyphicon-edit" aria-hidden="true"></span></a>
                </div>
            </div>
        </div>
